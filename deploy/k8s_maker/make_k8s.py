...
def make_k8s_template2():

    # Database
    template_name = 'azure_k8s_04_database.yaml'
    tf = TemplateFormatter(specs_01.specs_01, template_name)
    db_content = tf.formatted_output

    # App
    template_name = 'azure_k8s_04_app.yaml'
    output_file = f'dpcreator_05_{get_yyyy_mmdd()}.yaml'

    tf2 = TemplateFormatter(specs_01.specs_01, template_name)

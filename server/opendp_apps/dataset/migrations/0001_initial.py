    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unverified_data_profile', models.JSONField(blank=True, default=None, encoder=django.core.serializers.json.DjangoJSONEncoder, help_text='Unverified data profile', null=True)),
                ('data_profile', models.JSONField(blank=True, null=True)),
                ...
                ('wizard_step', models.CharField(choices=[('step_100', 'Step 1: New Dataset Info'), ('step_200', 'Step 2: File Upload'), ('step_300', 'Step 3: Dataset Questions'), ('step_400', 'Step 4: Confirm Variables'), ('step_500', 'Step 5: Set Epsilon')], default='step_100', max_length=128)),
            ],
            options={

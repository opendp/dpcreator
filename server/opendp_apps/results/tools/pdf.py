...
class RenderPDF(object):
    ...
    def __init__(self, statistics: List[tuple], histograms: List[Tuple[str, Dict]], figure_width=8):
        """
    ...
    def build_statistics_table(self):
        ...
        with self.doc.create(Section('DP Statistics')):
            ...
            table1.add_hline()
            for stat, value in self.statistics:
    ...
    def build_histograms(self):
        ...
        for i, (name, hist_dict) in enumerate(self.histograms):
...
if __name__ == '__main__':
    ...
    renderer = RenderPDF(statistics, histograms)

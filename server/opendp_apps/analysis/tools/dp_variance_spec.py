"""
Wrapper class for DP Variance functionality
...
class DPVarianceSpec(StatSpec):
    ...
    spec_props = dict(var_name="hours_sleep",
                      ...
                      statistic=DP_VARIANCE,
                      dataset_size=365,
                      epsilon=0.5,
                      cl=CL_95,
                      fixed_value=1)
    """
    STATISTIC_TYPE = astatic.DP_VARIANCE
    ...
    def get_preprocessor(self):
        ...
        self.scale = binary_search(lambda s: self.check_scale(s, preprocessor, self.max_influence, self.epsilon), bounds=(0.0, 100000.0))

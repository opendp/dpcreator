    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dv_general_token', django_cryptography.fields.encrypt(models.CharField(blank=True, max_length=255))),
                ('dv_sensitive_token', django_cryptography.fields.encrypt(models.CharField(blank=True, max_length=255))),
